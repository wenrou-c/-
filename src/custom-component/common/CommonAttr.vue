        ...
        <el-collapse-item title="通用样式" name="1">
            <el-form :model="currentComponent" label-width="80px">
                ...
                <el-form-item label="字体大小">
                    <el-input v-model="currentComponent.style.fontSize" />
                </el-form-item>
                <el-form-item label="字体粗细">
                    <el-input v-model="currentComponent.style.fontWeight" />
                </el-form-item>
                ...
                <el-form-item label="字体颜色">
                    <el-color-picker v-model="currentComponent.style.color" show-alpha :predefine="predefineColors" />
                </el-form-item>
                <el-form-item label="边框颜色">
                    <el-color-picker v-model="currentComponent.style.borderColor" show-alpha
                        :predefine="predefineColors" />
                </el-form-item>
                ...
                <el-form-item label="边框宽度">
                    <el-input v-model="currentComponent.style.borderWidth" />
                </el-form-item>
